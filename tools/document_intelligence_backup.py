...
import mimetypes
        ...
        if missing_deps:
            logger.warning(f"Some document processing dependencies are missing: {missing_deps}. Limited functionality available.")ed document processing with OCR, analysis, and multi-document synthesis
"""
